    ...
    if test in test_list:
        ...
        for LED in led_list:
            ...
            for vin in vin_list:    
                ...
                i2c_dimming(LED = LED, vin = vin, start = 0, end = 254, step = 3, cp = 1, i2c_type=i2c_type, soak = 10, delay_per_line = 1, delay_per_load = 1)
    ...
    if test in test_list:
        ...
        for LED in led_list:
            ...
            for vin in vin_list:    
                """MIN to MAX"""
                ate_gui.click(vin_dict[f"{LED}V {vin}Vac"])
                i2c_dimming(LED = LED, vin = vin, start = 254, end = 0, step = 3, cp = 1, i2c_type=i2c_type, soak = 10, delay_per_line = 1, delay_per_load = 1)
