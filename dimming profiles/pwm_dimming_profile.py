...
frequency = sys.argv[4] # frequency
test = f"PWM Dimming"
    ...
    if test in test_list:
        ...
        for LED in led_list:
            ...
            for vin in vin_list:    
                ...
                pwm_dimming(LED = LED, vin = vin, start = 0, end = 100, step = 1, frequency = 2000, soak = 10, delay_per_line = 1, delay_per_load = 1)
    ...
    if test in test_list:
        ...
        for LED in led_list:
            ...
            for vin in vin_list:    
                """MIN to MAX"""
                ate_gui.click(vin_dict[f"{LED}V {vin}Vac"])
                pwm_dimming(LED = LED, vin = vin, start = 100, end = 0, step = 1, frequency = 2000, soak = 10, delay_per_line = 1, delay_per_load = 1)
